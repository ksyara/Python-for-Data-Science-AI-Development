...
def get_pie_chart(value):
    ...
    if value == 'All Sites':
        ...
        fig = px.pie(filtered_df,values='class count',names='class',title=f'Total Launches for site {value}')
        return fig
# TASK 4:
...
def get_sscatter(value1,value2):
    ...
    if value1 == 'All Sites':
        ...
        filtered_df2_2 = spacex_df[spacex_df['Launch Site'] == value1]
